...
set_property IOB          true     [ get_ports -regexp {NexysA7_GPIO_Seg7_Cathode_n\[\d+\]} ]  ; # enforce last FF in IOB
...
set_property IOB          true     [ get_ports -regexp {NexysA7_GPIO_Seg7_Anode_n\[\d+\]} ]  ; # enforce last FF in IOB
