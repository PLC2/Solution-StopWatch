...
set_output_delay -clock [ get_clocks SystemClock ] -min 0.100 [get_ports -regexp {NexysA7_GPIO_Seg7_Cathode_n\[\d+\]} ]
set_output_delay -clock [ get_clocks SystemClock ] -max 0.200 [get_ports -regexp {NexysA7_GPIO_Seg7_Cathode_n\[\d+\]} ]
...
set_output_delay -clock [ get_clocks SystemClock ] -min 0.100 [get_ports -regexp {NexysA7_GPIO_Seg7_Anode_n\[\d+\]} ]
set_output_delay -clock [ get_clocks SystemClock ] -max 0.200 [get_ports -regexp {NexysA7_GPIO_Seg7_Anode_n\[\d+\]} ]
